...
if sys.version_info[:2] < (2, 7):
    ...
    print('')
    print("You'll need to use Ubuntu 18.04 or 20.04.")
    print('')
...
DISTRO_UBUNTU_RELS = ['18.04', '20.04']
...

=s9tY
...
class Installer(object):
    ...
    def get_distro_and_version(self):
        try:
            ...
            print('')
            print(color.bold("You'll need to use Ubuntu 18.04 or 20.04."))
            print('')
    ...
    def add_repo(self):
        def add_repo_deb():
            ...
            contents = 'deb {0} {codename} main'.format(
                REPO_URL, codename=DISTRO_UBUNTU_CODENAMES[self.distroversion])
    ...
    def install_packages(self):
        ...
        def wait_for_apt():
            ...
            try:
                for i in range(100):
                    stdout = cmd(['ps', '-e', '-o', 'pid,args']).decode()
        ...
        def install_packages_deb():
            ...
            try:
                ...
                # Some systems don't have gpg/gnupg installed by default (required by apt-key).
                wait_for_apt()
                check_exec_cmd(['apt-get', '--assume-yes', 'install', 'gnupg'])
